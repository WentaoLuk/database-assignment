...
INSERT INTO Customer_T( Cust_Id, Cust_Fname, Cust_Lname, Cust_Phone, Cust_Address, Cust_City, Cust_Prov, Cust_PostCode, Cust_Balance )
  VALUES( 'C001', 'Wentao', 'Lu', '613-727-4723', '1385 Woodroffe Ave', 'Ottawa', 'ON', 'K2G1V8', 63234.00 );
INSERT INTO Customer_T( Cust_Id, Cust_Fname, Cust_Lname, Cust_Phone, Cust_Address, Cust_City, Cust_Prov, Cust_PostCode, Cust_Balance )
  VALUES( 'C002', 'Thomas', 'Delauer', '613-727-4723', '1385 Woodroffe Ave', 'Ottawa', 'ON', 'K2G1V8', 66.00 );
INSERT INTO Customer_T( Cust_Id, Cust_Fname, Cust_Lname, Cust_Phone, Cust_Address, Cust_City, Cust_Prov, Cust_PostCode, Cust_Balance )
  VALUES( 'C003', 'Bill', 'Johnson', '613-727-4723', '1385 Woodroffe Ave', 'Ottawa', 'ON', 'K2G1V8', 64351.00 );
INSERT INTO Customer_T( Cust_Id, Cust_Fname, Cust_Lname, Cust_Phone, Cust_Address, Cust_City, Cust_Prov, Cust_PostCode, Cust_Balance )
  VALUES( 'C004', 'Chirs', 'Wu', '613-727-4723', '854 Younge Street' , 'Toronto','ON', 'K2G1V8', 777.00 );
INSERT INTO Customer_T( Cust_Id, Cust_Fname, Cust_Lname, Cust_Phone, Cust_Address, Cust_City, Cust_Prov, Cust_PostCode, Cust_Balance )
  VALUES( 'C005', 'Brad', 'Pitt', '613-727-4723', '264 Main Street'   , 'Kitchener', 'ON', 'K2G1V8', 745231.00 );
INSERT INTO Customer_T( Cust_Id, Cust_Fname, Cust_Lname, Cust_Phone, Cust_Address, Cust_City, Cust_Prov, Cust_PostCode, Cust_Balance ) 
  VALUES( 'C006', 'Donald', 'Sutherland', '613-727-4723', '357 Rue Catherine' , 'Montreal', 'ON', 'K2G1V8', 161454.00 );
